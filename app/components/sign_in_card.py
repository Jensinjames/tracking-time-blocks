    ...
    return rx.el.div(
        ...
        rx.el.form(
            ...
            rx.el.button(
                "Sign In",
                type="submit",
                class_name="w-full bg-blue-600 text-white font-semibold py-2.5 px-4 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors",
            ),
            rx.el.div(
                rx.el.span(
